...
use App\models\MultiplicationVerticalCross as CurrentModel;

class MultiplicationVerticalCrossSeeder extends Seeder
{
    /**
    ...
    protected function factory(string $level, string $difficulty, int $numItems): array
    {
        ...
        $mulVerticalCross = new MultiplicationVerticalCross($level, $difficulty);
        $quizzes = collect($mulVerticalCross->get($numItems));
