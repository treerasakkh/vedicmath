...
use App\models\MultiplicationBaseShift as CurrentModel;

class MultiplicationBaseShiftSeeder extends Seeder
{
    /**
    ...
    protected function factory(string $level, string $difficulty, int $numItems): array
    {
        ...
        $mulBaseShift = new MultiplicationBaseShift($level, $difficulty);
        $quizzes = collect($mulBaseShift->get($numItems));
