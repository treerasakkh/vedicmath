...
use App\models\SubtractionTen as CurrentModel;

class SubtractionTenSeeder extends Seeder
{
    /**
    ...
    protected function factory(string $level, string $difficulty, int $numItems): array
    {
        ...
        $subTen = new SubtractionTen($level, $difficulty);
        $quizzes = collect($subTen->get($numItems));
