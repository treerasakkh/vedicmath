...
use App\models\DivisionNikhilam as CurrentModel;

class DivisionNikhilamSeeder extends Seeder
{
    /**
    ...
    protected function factory(string $level, string $difficulty, int $numItems): array
    {
        ...
        $divNikhilam = new DivisionNikhilam($level, $difficulty);
        $quizzes = collect($divNikhilam->get($numItems));
