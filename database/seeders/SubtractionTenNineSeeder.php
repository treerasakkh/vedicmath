...
use App\Models\SubtractionTenNine as CurrentModel;
use Illuminate\Database\Seeder;

class SubtractionTenNineSeeder extends Seeder
{
    /**
    ...
    protected function factory(string $level, string $difficulty, int $numItems): array
    {
        ...
        $subTenNine = new SubtractionTenNine($level, $difficulty);
        $quizzes = collect($subTenNine->get($numItems));
